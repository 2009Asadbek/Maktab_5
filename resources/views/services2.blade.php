        ...
        <div class="container">
            ...
            <div class='serviceTabs'>
                <ul class='nav nav-tabs' id='myTab' role='tablist'>
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link show active " data-toggle="tab" href="#tab2" role="tab"
            ...
            <div class='tab-content'>
                <div class='tab-pane fade ' id='tab1' role='tabpanel'>
                    <div class='servicesList'>
                        ...
                        <a href="/uploads/lb7cNZPSEHlWeK1oAl0rZUXmhSuXxbq9.pdf">
                            <div>
                                <div class="icon">
                                    <img alt="icon" src="/uploads/2021/10/LndzkRNjthNcSHN5805syg4hkvVHGXV6.jpg">
                                </div>
