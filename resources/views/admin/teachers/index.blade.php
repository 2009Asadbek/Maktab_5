                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>O'qituchilar</h3>
                            <a href="{{ route('admin.teachers.create') }}" class="btn btn-success">Qo'shish</a>
                        </div>
                        <div class="card-body">
