...
<head> 
    ...
    <link href="/img/favicon.png?v1" rel="shortcut icon" type="image/png">
    ...
    <div class="menuContent">
        ...
        <div class="container h-100">
            <div class="menuContentInner show">
                <img src="/img/logo-removebg-preview.svg" alt="logo">
        ...
        <div class="container">
            <div class="headerMenuBox">
                ...
                <a href="{{ route('index') }}" class="mainLogo">
                    <img alt="logo" class="inlinesvg" src="/img/logo-removebg-preview.png">
                </a>
                    ...
                    <div class="menusList">
                        ...
                        <div class="bottomMainMenu">
                            <ul class="menu">
                                ...
                                <li><a href="#">@lang('words.contactUs')</a></li>
